...
- En el codigo, las comparaciones para verificar duplicados hacen uso de strcmp, sensible a mayúsculas, por lo tanto, strings como 'casa' y 'cAsa', no se consideran duplicados.
